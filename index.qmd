...
<div style="display: flex; justify-content: center; align-items: center; gap: 2rem; margin: 4rem auto 4rem auto;">
	<img src="images/logo.png" width="220" alt="MEEM Lab logo" aria-label="Lab logo">
	<a href="https://www.wgtn.ac.nz/" target="_blank" rel="noopener">
		<img src="images/vuw-logo.png" width="120" alt="Victoria University of Wellington logo" aria-label="University logo">
	</a>
</div>
...
![Lab shark photo](images/shark.jpg){width=420px style="display:block;margin:2rem auto 1rem auto;border-radius:18px;" alt="Lab member diving with shark" aria-label="Lab shark photo"}
